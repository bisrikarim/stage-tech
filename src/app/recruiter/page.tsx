    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10">
        ...
        <Link href="/recruiter/post"
          className="inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2.5 rounded-xl font-semibold text-sm transition">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        {[
          { icon: <Briefcase className="w-6 h-6 text-emerald-500" />, label: "Stages publiés", value: myInternships.length, bg: "bg-emerald-50 dark:bg-emerald-900/20" },
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-6">
          <div className="flex items-center justify-between mb-5">
            ...
            <Link href="/recruiter/post" className="text-sm text-emerald-600 dark:text-emerald-400 hover:underline flex items-center gap-1">
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-6">
          <div className="flex items-center justify-between mb-5">
            ...
            <Link href="/recruiter/applicants/1" className="text-sm text-emerald-600 dark:text-emerald-400 hover:underline flex items-center gap-1">
